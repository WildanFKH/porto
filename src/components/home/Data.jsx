...
const Data = () => {
  return (
    <div className="home_data">
        <h1 className="home_title">Wildan Faizul Khanafi
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home_description">i'm a Web Devloper based in Indonesia, and i'm very passioned and dedicated to my work.</p>
